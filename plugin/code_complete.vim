...
"       cc<tab>              --插入/* */注释框架
"       cd<tab>              --插入/**< */注释框架
"       de<tab>              --插入#define xxx
"       ff<tab>              --插入头文件预编译选项
"       fN<tab>              --函数定义框架模板补全,N为定义函数参数个数
"       is<tab>              --#include <>
"       in<tab>              --#include ""
"       main<tab>            --带参数的main函数框架
"       nm<tab>              --生成namespace代码框架
"       ifeN<tab>       --if-else...,N为分支个数
"       switchN<tab>    --switch...<tab>键切换焦点,其中N为分支个数
"       (<tab>键切换焦点)
"
"           variables:
"
